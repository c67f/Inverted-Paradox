class Battle extends Phaser.Scene {
    ...
    init() {
        ...
        this.charMenuX = width/3
        this.charMenuY = this.HPTextY - 20

        this.cursorStartX = width/2.8
        this.cursorStartY = height*0.42
        this.cursorMoveInterval = 130
        this.cursorMenuX = this.charMenuX
        this.cursorMenuY = this.charMenuY + 32

        keyLEFT = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.LEFT)
        keyRIGHT = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.RIGHT)
        keyUP = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.UP)
        keyDOWN = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.DOWN)
        keySPACE = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.DOWN)
    ...
    create() {
        ...
        this.battleCursor = new BattleCursor(this, this.cursorStartX, this.cursorStartY, 'cursorParty', 0).setOrigin(0.5, 1)
